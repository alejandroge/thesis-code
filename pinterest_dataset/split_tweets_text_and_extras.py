...
lang = 'eng'
text_file = main_dir+'clef2015_'+lang+'_tweets.txt'
words_file = main_dir+'clef2015_'+lang+'_words.txt'
emo_file = main_dir+'clef2015_'+lang+'_emoticons.txt'
hash_file = main_dir+'clef2015_'+lang+'_hashtags.txt'
at_file = main_dir+'clef2015_'+lang+'_ats.txt'
link_file = main_dir+'clef2015_'+lang+'_links.txt'
...
with open(text_file,'r') as text_reader, open(words_file,'w', encoding='utf-8') as words_writer, open(emo_file, 'w',encoding='utf-8') as emo_writer, open(hash_file,'w',encoding='utf-8') as hash_writer, open(at_file,'w',encoding='utf-8') as at_writer, open(link_file,'w',encoding='utf-8') as link_writer:
